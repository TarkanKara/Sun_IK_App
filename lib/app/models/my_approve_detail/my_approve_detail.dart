...
//
//     final MyApproveDetailModel = MyApproveDetailModelFromJson(jsonString);

// ignore_for_file: non_constant_identifier_names, constant_identifier_names

import 'dart:convert';

MyApproveDetailModel? MyApproveDetailModelFromJson(String str) =>
    MyApproveDetailModel.fromJson(json.decode(str));

String MyApproveDetailModelToJson(MyApproveDetailModel? data) =>
    json.encode(data!.toJson());

class MyApproveDetailModel {
  ...
  factory MyApproveDetailModel.fromJson(Map<String, dynamic> json) =>
      MyApproveDetailModel(
...
class Data {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "SALARYPERMISSIONMODEL": salarypermissionmodel!.toJson(),
...
class RequestDetailKeyValue {
  ...
  factory RequestDetailKeyValue.fromJson(Map<String, dynamic> json) =>
      RequestDetailKeyValue(
        ...
        name: json["Name"],
        value: json["Value"],
        designName: designNameValues.map[json["DesignName"]],
  ...
  Map<String, dynamic> toJson() => {
        ...
        "Name": name,
        "Value": value,
        "DesignName": designNameValues.reverse![designName],
        "IsSuccess": isSuccess,
      };
}

enum DesignName { HEADER }

final designNameValues = EnumValues({"Header": DesignName.HEADER});
