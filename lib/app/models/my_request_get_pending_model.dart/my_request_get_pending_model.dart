...
class MyRequestGetPending {
  String? refreshToken;
  String? token;
  Data? data;

  MyRequestGetPending({this.refreshToken, this.token, this.data});

  MyRequestGetPending.fromJson(Map<String, dynamic> json) {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['PendingRequestList'] != null) {
      ...
      json['PendingRequestList'].forEach((v) {
        pendingRequestList!.add(PendingRequestList.fromJson(v));
      });
    }
