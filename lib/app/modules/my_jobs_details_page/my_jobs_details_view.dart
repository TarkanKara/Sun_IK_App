                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        "İş Oluşturulma Tarihi: ${DateTimeConverTo.compareToDateTime(controller.myJobsController.myJobs.data!.pendingJobsList![0].wORKCREATIONDATE.toString())}",
                        style: GoogleFonts.inter(
                    ...
                    Padding(
                      padding: EdgeInsets.only(top: 2.h),
                      child: Text(
                        "Talep Eden: ${controller.myJobsController.myJobs.data!.pendingJobsList![0].eMPLOYEENAMESURNAME}",
                        style: GoogleFonts.inter(
                            fontSize: 2.h, color: Colors.black),
                      ),
                    ),
                    Padding(
                      padding: EdgeInsets.only(top: 2.h),
                      child: Text(
                        "Atanan Kişi: ${controller.myJobsController.myJobs.data!.pendingJobsList![0].aSSIGNEMPLOYEE}",
                        style: GoogleFonts.inter(
                            fontSize: 2.h, color: Colors.black),
                      ),
                    ),
                    Padding(
                      padding: EdgeInsets.only(top: 2.h),
                      child: Text(
                        "Durum: ${controller.myJobsController.myJobs.data!.pendingJobsList![0].wORKSTATUSNAME}",
                        style: GoogleFonts.inter(
                            fontSize: 2.h, color: Colors.black),
