...
//
//     final myRequestDetailModel = myRequestDetailModelFromJson(jsonString);

// ignore_for_file: constant_identifier_names

import 'dart:convert';

MyRequestDetailModel? myRequestDetailModelFromJson(String str) =>
    MyRequestDetailModel.fromJson(json.decode(str));

String myRequestDetailModelToJson(MyRequestDetailModel? data) =>
    json.encode(data!.toJson());

class MyRequestDetailModel {
  MyRequestDetailModel({
    this.refreshToken,
    this.token,
    this.data,
  });
  ...
  factory MyRequestDetailModel.fromJson(Map<String, dynamic> json) =>
      MyRequestDetailModel(
