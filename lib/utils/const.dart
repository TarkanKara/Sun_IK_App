...
class Const {
  ...
  // HomePage
  // Colors
  static const Color STATUSBARCOLOR = Color(0xffEF3E52);
  static const Color NOTIFICATIONICONCOLOR = Color(0xffFDC330);
  static const Color NOTIFICATIONCONTAINERCOLOR = Colors.red;
  static const Color CIKISYAPICONCOLOR = Color(0xffFF5B5B);
  static const Color MENUCOLOR = Colors.white;
  static const Color BASLIKTEXTCOLOR = Color.fromARGB(255, 72, 74, 77);
  ...
  static const String ONAYLARIMTEXT = "Onaylarım";
  static const String ISLERIMTEXT = "İşlerim";
  static const String BORDROLARIMTEXT = "Bordrolarım";
  static const String IZINLERIMTEXT = "İzinlerim";
  static const String IZINBAKIYESITEXT = "İzin\nBakiyesi";
  static const String IZINBASLANGICTEXT = "İzin Başlangıç Tarihi";
  static const String IZINGUNTEXT = "İzin Gün Sayısı";
}