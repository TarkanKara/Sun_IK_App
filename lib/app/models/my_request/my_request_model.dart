...
class MyRequestModel {
  ...
  MyRequestModel({this.refreshToken, this.token, this.data});
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['MyRequestList'] != Object) {
      myRequestList = <MyRequestList>[];
      json['MyRequestList'].forEach((v) {
        myRequestList!.add(MyRequestList.fromJson(v));
      });
    }
...
class MyRequestList {
  ...
  String? rEQEMPLOYEE;
  int? rEQIDHREMPLOYEE;
  Object? aSSIGNEMPLOYEE;
  int? rEQTYPE;
  String? eMPLOYEENAMESURNAME;
  String? rEQUESTDETAIL;
  Object? rEQUESTDETAILKEYVALUE;
  Object? rEQUESTDETAILKEYVALUESALARY;
  String? uID;
  int? sTATU;
  String? sTATUNAME;
  Object? hISTORY;
  ...
  bool? iSWORK;
  bool? iSCOMPENSATION;
  Object? sALARYPERMISSIONMODEL;
  bool? gETOPINION;
  Object? gETOPINIONLIST;
